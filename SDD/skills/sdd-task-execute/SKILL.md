...
description: >-
  Thực thi đúng một task SDD trong dự án. Dùng khi user nói "thực hiện
...
1. **DỪNG** — không tự quyết định silently
...
## Bước 6: Kiểm tra API contract
- API contract đã khớp với các Backend service chưa?

## Bước 7: Tóm tắt sau khi xong
...
- Dùng skill `update-backlog` để cập nhật trạng thái task vừa hoàn thành vào `specs/BACKLOG.md`
